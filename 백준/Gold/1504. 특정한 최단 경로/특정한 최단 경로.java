...
class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int shortest = Math.min(oneToa + bToN , oneTob + aToN) + aTob;


        if((oneToa == Integer.MAX_VALUE || bToN == Integer.MAX_VALUE || aTob == Integer.MAX_VALUE) &&
                (oneTob == Integer.MAX_VALUE || aToN == Integer.MAX_VALUE || aTob == Integer.MAX_VALUE)) System.out.println(-1);
